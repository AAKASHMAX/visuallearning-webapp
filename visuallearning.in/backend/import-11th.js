...
async function main() {
  const data = JSON.parse(fs.readFileSync("import-data-11th.json", "utf-8"));

  // Only delete Class 11 Physics chapters
  const physicsSubjectId = data[0].dbSubjectId;
  console.log("Deleting existing Class 11 Physics chapters...");
  ...
  console.log(`\n=== Import Complete (Class 11 Physics) ===`);
