...
import { Sparkles, FileText, BookMarked, HelpCircle, ClipboardList, ChevronRight, GraduationCap, type LucideIcon } from "lucide-react";
...
export default function SubjectContentTypesPage() {
  ...
  const contentTypes: ContentType[] = [
    ...
    { slug: "lecture", title: "Lecture Videos", subtitle: "Recorded teacher lessons", icon: GraduationCap, gradient: "from-sky-500 to-blue-600", badge: "bg-sky-100 text-sky-700" },
