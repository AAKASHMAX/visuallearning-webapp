...
// Real recorded teacher lectures (Hinglish) from Class 12 Physics — Chapter 1:
// Electric Charges and Fields.
const lectures: DemoLecture[] = [
  ...
  { title: "Electric field & field lines", klass: "Class 12", subject: "Physics", chapter: "Electric Charges and Fields", youtubeId: "xgfdxMwwlcE" },
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-6 flex flex-col gap-3">
        <div className="inline-flex w-fit items-center gap-2 rounded-full bg-gradient-to-r from-sky-500/10 to-blue-500/10 px-4 py-1.5 text-xs font-black uppercase tracking-wider text-blue-600">
        ...
        <p className="max-w-2xl text-sm leading-relaxed text-text-muted sm:text-base">
          Learn every concept with recorded teacher lessons that break down each topic step by step, just like a live class.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-6 lg:flex-row">
        ...
        <div className="flex-1">
          ...
          <div className="mt-5 rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            <span className="inline-flex items-center gap-1.5 rounded-full bg-blue-100 px-2.5 py-0.5 text-[10px] font-black uppercase tracking-wide text-blue-600">
        ...
        <div className="w-full lg:w-80">
          <div className="rounded-2xl border border-gray-200 bg-white shadow-sm">
            <div className="border-b border-gray-100 px-5 py-4">
              ...
              <p className="mt-1 text-xs text-text-muted">{lectures.length} lecture videos · Hinglish</p>
            </div>
          ...
          {/* CTA card */}
          <div className="mt-4 overflow-hidden rounded-2xl bg-gradient-to-br from-sky-500 via-blue-600 to-indigo-600 p-5 text-white shadow-lg shadow-blue-500/20">
            <h4 className="text-lg font-black">Unlock All Lectures</h4>
            <p className="mt-1.5 text-xs leading-relaxed text-white/70">
              Get full access to recorded lecture videos for every chapter across Class 9-12.
            </p>
            <Link
              href="/courses"
              className="mt-4 inline-flex items-center gap-2 rounded-lg bg-white px-4 py-2.5 text-sm font-bold text-blue-600 shadow-md transition-all hover:gap-3 hover:shadow-lg"
            >
              View Plans
