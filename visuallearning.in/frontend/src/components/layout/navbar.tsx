...
function NotificationBell({ align = "right" }: { align?: "left" | "right" }) {
  ...
  return (
    <div className="relative">
      ...
      >
        <Bell className="h-5 w-5 fill-white/20" strokeWidth={2.6} />
        {unreadCount > 0 && (
          <span className="absolute -right-1.5 -top-1.5 flex min-h-5 min-w-5 items-center justify-center rounded-full bg-red-500 px-1.5 text-[10px] font-black leading-none text-white ring-2 ring-white">
