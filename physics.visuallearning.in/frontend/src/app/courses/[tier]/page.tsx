          ...
          {cards.map((card) => {
            ...
            return (
              <Link
                ...
                className={`group relative flex flex-col rounded-2xl border ${card.border} bg-card p-7 transition-all duration-300 hover:-translate-y-1.5 hover:border-accent/40`}
              >
                <div className={`mb-5 flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br ${card.gradient} transition-transform duration-300 group-hover:scale-110`}>
                  <Icon className="h-6 w-6 text-white" />
                </div>
                <h3 className="text-lg font-bold text-text-bright">{card.title}</h3>
