  ...
  return (
    <div>
      ...
      <div className="flex gap-2 mb-6 flex-wrap">
        {(["classes", "subjects", "chapters", "videos"] as Tab[]).map((t) => (
      ...
      <div className="flex gap-3 mb-4 flex-wrap">
        {(tab === "subjects" || tab === "chapters" || tab === "videos") && (
        ...
        {(tab === "chapters" || tab === "videos") && selectedClass && (
      ...
      <div className="flex justify-end mb-4">
        <Button onClick={() => { setShowForm(!showForm); setEditing(null); setFormData({}); }}>
          {showForm ? <><X className="w-4 h-4 mr-1" />Cancel</> : <><Plus className="w-4 h-4 mr-1" />Add {tab.slice(0, -1)}</>}
        </Button>
      </div>
