...
import {
  ...
  Sparkles, GraduationCap, Atom, PenTool, ClipboardList,
} from "lucide-react";
...
const contentSections = [
  ...
  },
  {
    ...
    description: "Expert teachers explain every chapter with crystal-clear animated video lessons",
    gradient: "from-blue-500 via-cyan-500 to-teal-500",
    bgLight: "bg-blue-50",
    iconColor: "text-blue-600",
    taglines: [
      { text: "Chapter-wise complete coverage", color: "bg-blue-100 text-blue-700" },
      { text: "Taught by experienced educators", color: "bg-cyan-100 text-cyan-700" },
      { text: "HD quality, watch anytime", color: "bg-teal-100 text-teal-700" },
      { text: "Pause, rewind, learn at your pace", color: "bg-sky-100 text-sky-700" },
    ],
    image: "🎬",
  },
  {
    ...
    icon: Radio,
    title: "Live Classes",
    description: "Join real-time interactive sessions with teachers, ask doubts & learn together",
    gradient: "from-red-500 via-rose-500 to-pink-500",
    bgLight: "bg-red-50",
    iconColor: "text-red-600",
    taglines: [
      { text: "Real-time doubt solving", color: "bg-red-100 text-red-700" },
      { text: "Interactive whiteboard sessions", color: "bg-rose-100 text-rose-700" },
      { text: "Chat with teachers & classmates", color: "bg-pink-100 text-pink-700" },
      { text: "Never miss a class — join from anywhere", color: "bg-orange-100 text-orange-700" },
    ],
    image: "📡",
  },
  {
